...
public class TemperatureActuatorResource extends CoapSenmlActuatorResource<TemperatureSmartActuator> {
    ...
    public TemperatureActuatorResource(String deviceId, String name, TemperatureSmartActuator actuator) {
    ...
    private Optional<String> getJsonSenmlResponse() {
        try {
            ...
            statusRecord.setVs(TemperatureSmartActuator.getStatusDescription(this.actuator.getStatus()));
    ...
    private void handleDeltaPutRequest(CoapExchange exchange) {
        String payload = new String(exchange.getRequestPayload());

        this.actuator.setDelta(Double.parseDouble(payload));

        exchange.respond(CoAP.ResponseCode.CHANGED);
    }


    private void handleWantedValuePutRequest(CoapExchange exchange) {
        String payload = new String(exchange.getRequestPayload());
