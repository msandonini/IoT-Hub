...
public class TemperatureSmartActuator extends GenericActuator<Double, Integer> {
    ...
    public TemperatureSmartActuator() {
        this(DEFAULT_WANTED_TEMPERATURE, DEFAULT_TEMPERATURE_DELTA);
    }

    public TemperatureSmartActuator(double wantedTemperature) {
        this(wantedTemperature, DEFAULT_TEMPERATURE_DELTA);
    }

    public TemperatureSmartActuator(double wantedTemperature, double temperatureDelta) {
