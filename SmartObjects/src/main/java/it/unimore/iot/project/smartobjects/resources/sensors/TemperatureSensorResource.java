...
public class TemperatureSensorResource extends CoapSenmlSensorResource<TemperatureSmartSensor> {
    ...
    public TemperatureSensorResource(String deviceId, String name, TemperatureSmartSensor sensor) {
